...
jest.mock("@/components/filters/AdvancedSearchHeader", () => () => <div>AdvancedSearchHeader</div>);
jest.mock("@/components/filters/SearchInput", () => () => <div>SearchInput</div>);
jest.mock("@/components/filters/FilterPanel", () => ({ onClose }: any) => (
  <div>
    FilterPanel
    <button onClick={onClose}>Close</button>
  </div>
));
jest.mock("@/components/filters/SearchMetaInfo", () => ({ activeFilters }: any) => (
  <div>SearchMetaInfo with {activeFilters.length} filters</div>
));
